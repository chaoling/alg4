public class Board {
    ...
    public Board twin() {
        ...
        int[][] twinBlks = new int[mDim][mDim];
    ...
    public Iterable<Board> neighbors() {
        ...
        int[][] nextBlks = new int[mDim][mDim];
    ...
    private int mandist(int x, int y, int val) {
    ...
    private void swap(int[][] tiles, int x0, int y0, int x1, int y1) {
        int tmp = tiles[x0][y0];
